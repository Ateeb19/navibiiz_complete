...
const Cars = () => {
    ...
    const filteredCompanies = company_info.filter((item) => item.car_service === "1");
    ...
    return (
        <div>
            ...
            <h2 className="text-uppercase">cars</h2>
            <div>
                {
                    mode === 'offline' ?
            ...
            <div className="d-flex flex-column justify-content-center align-items-center ">
                ...
                <div className='container py-3 row'>
                    {filteredAndSearchedCompanies.length > 0 ? (
                        ...
                        <div className="text-center text-muted">No companies available with car service.</div>
                    )}
                </div>
            </div>
