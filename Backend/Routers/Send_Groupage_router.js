...
const {  send_groupage_submit, display_user_dashboard, delete_groupage, show_all_groupage, create_offer, show_offers_user, delete_offer_user, groupage_info, update_stats_offer } = require('../Controllers/Send_Groupage_controller.js');
