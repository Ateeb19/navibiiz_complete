...
const { Register, login, update_user_name, update_user_password, display_profile, token_check, Send_message, payment_history, reset_password, froget_password, total_number_orders, user_upcoming, comapny_details, user_delete, googleLogin } = require('../Controllers/User_controller.js');
