...
const { Display_company, Delete_company_admin, Display_offers, total_offers_sent, total_offer_accepted, edit_company_details, Delete_company_details_country, add_company_country, edit_logo, selected_offer, edit_company_documents, delete_offer, pending_offers } = require('../Controllers/Admin_controller.js');
...
Routers.route('/pending_offers').get(AuthenticateToken, pending_offers);
